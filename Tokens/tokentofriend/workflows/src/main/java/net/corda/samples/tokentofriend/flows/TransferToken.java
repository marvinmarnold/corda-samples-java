...
public class TransferToken extends FlowLogic<String>{
    ...
    public String call() throws FlowException {
        ...
        SignedTransaction partiallySignedTx = getServiceHub().signInitialTransaction(transactionBuilder, ImmutableList.of(getOurIdentity().getOwningKey()));
        ...
        return subFlow(new ObserverAwareFinalityFlow(fullySignedTx, Arrays.asList(customerSession, dealerSession)));
    }
}
